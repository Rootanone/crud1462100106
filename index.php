...
<head>
    ...
    <meta name="description" content="PTS PAW KELAS A SYARIFUDDIN HIDAYATUR RAMADHAN 1462100106">
...
<body class="bg-light">
    ...
    top: 0 !important; z-index : 99999 !important;">
        <div class="container-fluid container">
            <a class="navbar-brand" href="#">PTS PAW 1462100106</a>
            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="tambah.php" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Syarifuddin" required>
                    </div>
                    <div class="col-md-4">
                        <label for="NIM" class="form-label">NIM</label>
                        <input type="text" name="NIM" class="form-control" placeholder="1462100106" required>
                    </div>
